...
png(file="plot4.png")
par(mfrow=c(2,2))
plot(x=dt1$DateTime,dt1$Global_active_power, type="l", col=1, xlab="", ylab="Global Active Power")
plot(x=dt1$DateTime,dt1$Voltage/1000, type="l", col=1, xlab="datetime", ylab="Voltage")
...
legend("topright", 
       ...
       lty=c(1,1,1),
       col=c(1, "red","blue"))
plot(x=dt1$DateTime,dt1$Global_reactive_power, type="l", col=1, xlab="datetime",ylab="Global_reactive_power")
dev.off()
